...
mod case_statement_globbing {
    ...
    fn test_case_statement_glob_question_mark() {
        let mut executor = CommandExecutor::new();
        executor.variable_manager_mut().set("file".to_string(), "file1".to_string()).unwrap();
    ...
    fn test_case_statement_glob_character_class() {
        let mut executor = CommandExecutor::new();
        executor.variable_manager_mut().set("file".to_string(), "file5.txt".to_string()).unwrap();
    ...
    fn test_case_statement_glob_negated_class() {
        let mut executor = CommandExecutor::new();
        executor.variable_manager_mut().set("item".to_string(), "apple".to_string()).unwrap();
    ...
    fn test_case_statement_glob_multiple_patterns() {
        let mut executor = CommandExecutor::new();
        executor.variable_manager_mut().set("ext".to_string(), "txt".to_string()).unwrap();
    ...
    fn test_case_statement_glob_no_match_default() {
        let mut executor = CommandExecutor::new();
        executor.variable_manager_mut().set("input".to_string(), "unknown".to_string()).unwrap();
    ...
    fn test_case_statement_glob_exact_match_priority() {
        let mut executor = CommandExecutor::new();
        executor.variable_manager_mut().set("val".to_string(), "test".to_string()).unwrap();
    ...
    fn test_case_statement_glob_wildcard_all() {
        let mut executor = CommandExecutor::new();
        executor.variable_manager_mut().set("x".to_string(), "anything".to_string()).unwrap();
    ...
    fn test_case_statement_glob_escape_sequence() {
        let mut executor = CommandExecutor::new();
        executor.variable_manager_mut().set("file".to_string(), "*.txt".to_string()).unwrap();
    ...
    fn test_case_statement_glob_range_pattern() {
        let mut executor = CommandExecutor::new();
        executor.variable_manager_mut().set("num".to_string(), "7".to_string()).unwrap();
