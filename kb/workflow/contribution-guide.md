...
description: "Setup, workflow, state testing requirements, PR guidelines"
category: contribute
status: implemented
...
tags: []
weight: 1
aliases: ["/04-development/contribution-guide.md"]
---
...
**See Also**: [State-First Architecture](../01-architecture/01-state-first-principle.md), [Testing Guide](../02-how-to-guides/testing-guide.md)
...
- **Architecture**: [State-First Architecture](../01-architecture/01-state-first-principle.md)
