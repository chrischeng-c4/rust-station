...
**See Also**: [State-First Architecture](../01-architecture/01-state-first-principle.md) for deep dive
...
**See Also**: [Core Principles](../01-architecture/00-overview.md#cli-tui-separation)
...
**See Also**: [SDD Workflow Guide](../02-how-to-guides/sdd-workflow.md) for detailed decision matrix
...
**See Also**: [MCP Tools Reference](../04-reference/mcp/tools.md)
...
1. ✅ [Install rstn](../01-tutorials/installation.md)
2. ✅ [Run your first session](../01-tutorials/quick-start.md)
3. ✅ **Understand concepts** (you're here!)
4. → [Try SDD workflow](../02-how-to-guides/sdd-workflow.md)

### I'm a Contributor

1. ✅ Understand state-first architecture (above)
2. → [Read core principles](../01-architecture/00-overview.md)
3. → [Learn state-first details](../01-architecture/01-state-first-principle.md)
4. → [Follow SDD workflow](../02-how-to-guides/sdd-workflow.md)
5. → [Write state tests](../02-how-to-guides/testing-guide.md)

### I'm Integrating with Claude Code

1. ✅ Understand MCP concepts (above)
2. → [MCP Tools Reference](../04-reference/mcp/tools.md)
3. → [Claude CLI Reference](../04-reference/claude-code/cli-reference.md)
4. → [Headless Mode Patterns](../04-reference/claude-code/headless-mode.md)
...
**As a User**:
1. [Try interactive workflows in the TUI](../01-tutorials/quick-start.md)
2. [Learn SDD workflow basics](../02-how-to-guides/sdd-workflow.md)

**As a Contributor**:
1. [Read state-first architecture](../01-architecture/01-state-first-principle.md)
2. [Understand core principles](../01-architecture/00-overview.md)
3. [Learn testing requirements](../02-how-to-guides/testing-guide.md)

**For Claude Code Integration**:
1. [MCP Tools Reference](../04-reference/mcp/tools.md)
2. [Claude CLI Flags](../04-reference/claude-code/cli-reference.md)
