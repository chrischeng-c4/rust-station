...
- `dev-docs/architecture/11-workflow-system.md` - Workflow architecture
- `dev-docs/workflow/testing-guide.md` - General testing principles
- `dev-docs/architecture/02-state-first-principle.md` - State-first testing
